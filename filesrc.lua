...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Không Tên Blox Fruit chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Không Tên Blox Fruit", HidePremium = false, IntroText = "Không Tên Blox Fruit⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Không Tên Blox Fruit",
...
W:AddLabel("Không Tên Blox Fruit")
...
W:AddLabel("Không Tên Blox Fruit SCRIPT")
W:AddLabel("DiscordKhông Tên Blox Fruit")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Không Tên Blox Fruit(Noitification)",
